...
let editBoardName   = document.getElementById('boardname_edit');          // they need to be a 'let'
...
function editB() {
    const editBoards    = document.getElementsByClassName('editboard');
...
function insertTable() {
    ...
    .then(boards => {
        for (const key in boards) {
            ...
            elem.innerHTML = '<td role="button" data-href="./tasks.html?boardId=' + boards[key].BoardId + '">' + boards[key].BoardId +'</td>' 
            + '<td role="button" data-href="./tasks.html?boardId='+ boards[key].BoardId +'">' 
        ...
        deleteB(); 
        editBoardName = document.getElementById('boardname_edit'); 
        editB();  
    });
